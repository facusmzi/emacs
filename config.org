...
#+begin_src emacs-lisp
  (setq default-directory
        (expand-file-name "Documents/projects/" (getenv "USERPROFILE")))

  (defun user/open-emacs-config ()
    (interactive)
    (dired user-emacs-directory))

  (global-set-key (kbd "C-c e") #'user/open-emacs-config)
#+end_src
...
#+begin_src emacs-lisp
  (use-package vertico
    ...
    :custom
    (vertico-cycle t)                  ;; wrap around al llegar al final
...
#+begin_src emacs-lisp
  ...
  (use-package projectile
    ...
    :custom
    (projectile-completion-system 'default) ;; usa completing-read → vertico
